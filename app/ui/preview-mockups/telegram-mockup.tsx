    ...
    <>
      {isSquare ? (
        ...
        >
          ...
          <div className="my-1 flex w-full cursor-pointer justify-between rounded-[4px] border-l-[3px] border-[#5ca853] bg-[#5ca8531a] py-1 pl-1.5 pr-1.5 hover:bg-[rgba(92,168,83,0.2)] dark:border-white dark:bg-[#ffffff1a] dark:hover:bg-[rgba(255,255,255,0.2)]">
            ...
            <img
              ...
              alt="Preview"
              className="my-[3px] aspect-square w-full max-w-12 cursor-pointer rounded-[4px] object-cover"
            />
          </div>
        </div>
      ) : (
