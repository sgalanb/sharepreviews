                ...
                <div className="flex w-full flex-col items-center justify-center gap-4">
                  <div className="flex items-center justify-center gap-4">
                    <Image
                      ...
                      className="h-6 w-6 dark:invert"
                    />
                    <TypographyH3 className="">Telegram</TypographyH3>
                  </div>
                  <div className="flex w-full max-w-[451px] flex-col rounded-[15px] bg-[#e3fee0] px-2 pb-[5px] pt-1 font-[Roboto] antialiased dark:bg-[#8774e1]">
                    ...
                    <div className="my-1 flex w-full cursor-pointer flex-col rounded-[4px] border-l-[3px] border-[#5ca853] bg-[#5ca8531a] py-1 pl-1.5 pr-1.5 hover:bg-[rgba(92,168,83,0.2)] dark:border-white dark:bg-[#ffffff1a]">
                      {metatags['og:site_name'] && (
