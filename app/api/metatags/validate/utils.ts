...
export const getValidatedMetatags = async (url: string) => {
  ...
  const validatedMetatags: ValidatedMetatagsType = {
    ...
    'og:description': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#og:description',
    },
    'og:image': {
      ...
      info_url: '/blog/everything-you-should-know-about-open-graph#og:image',
    },
    'og:image:width': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#og:image:dimensions',
    },
    'og:image:height': {
    ...
    'og:image:type': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#og:image:type',
    },
    'og:url': {
      value: metatags['og:url'],
      errors: validateOgUrlErrors(metatags['og:url']),
      warnings: validateOgUrlWarnings(metatags['og:url']),
      info_url: '/blog/everything-you-should-know-about-open-graph#og:url',
    },
    'og:site_name': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#og:site_name',
    },
    'og:type': {
      value: metatags['og:type'],
      errors: validateOgTypeErrors(metatags['og:type']),
      warnings: validateOgTypeWarnings(metatags['og:type']),
      info_url: '/blog/everything-you-should-know-about-open-graph#og:type',
    },
    'twitter:title': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:title',
    },
    'twitter:description': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:description',
    },
    'twitter:card': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:card',
    },
    'twitter:image': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:image',
    },
    'twitter:image:width': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:image:dimensions',
    },
    'twitter:image:height': {
    ...
    'twitter:image:type': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:image:type',
    },
    'twitter:site': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:site',
    },
    'twitter:creator': {
      ...
      info_url:
        '/blog/everything-you-should-know-about-open-graph#twitter:creator',
    },
  }
