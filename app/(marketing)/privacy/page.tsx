  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-start gap-8 p-4 pt-16 lg:gap-20">
      ...
      <p>
        ...
        email addresses profile pictures Sensitive Information. We do not
        ...
        is stored by Lemon Squeezy. You may find their privacy notice link(s)
        here: https://www.lemonsqueezy.com/privacy.
        <br />
        ...
        with the requested service. To send administrative information to you.
        ...
        YOUR PRIVACY RIGHTS?&quot; below. To post testimonials. We post
        ...
        information with are as follows: Data Storage Service Providers Payment
        Processors User Account Registration & Authentication Services
        <br />
